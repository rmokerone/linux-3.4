...
/**************** start set resolution ******************/
	...
	if(wsize->height==480)  //   640*480
	{
		...
		sensor_write_value8(sd,0x01c6,0x00),
		sensor_write_value8(sd,0x01C7,0x80),    // UICONTRAST
	    sensor_write_value8(sd,0x0082,0x01);
	...
	if(wsize->height==1200)
	{
		...
		sensor_write_value8(sd,0x0086,0x03 );				 // FPSTYPE_CAP(15fps)
		sensor_write_value8(sd,0x0083,0x00 );			 // SENSMODE_CAP(Full) 
		sensor_write_value8(sd,0x01c6,0xf0), 
		sensor_write_value8(sd,0x01C7,0xa0),    // UICONTRAST
	...
	if(wsize->height==1936)  //   2592*1936
	{
		...
		sensor_write_value8(sd,0x0086,0x03);
		sensor_write_value8(sd,0x0083,0x00);
		sensor_write_value8(sd,0x01c6,0xf0),
		sensor_write_value8(sd,0x01C7,0xa0),    // UICONTRAST
		sensor_write_value8(sd,0x0082,0x01);
		printk("[gs5604] sensor_s_fmt 44  1936\n");
		msleep(200);
