...
#define __GS5604__
static void camera_pwr_on_gs5604(__u32 list_index, __camera_info_t *camera_info)
{
    __u32 CSI_AF_PWR_ON = 1;
...
static void camera_pwr_off_gs5604(__u32 list_index, __camera_info_t *camera_info)
{
    __u32 CSI_AF_PWR_OFF = 0;
...
static __s32 camera_detect_gs5604(__u32 list_index, struct i2c_adapter *i2c_adap)
{
    int ret;
	struct regval_list regs;
    __u32 i2c_addr  = camera_list[list_index].i2c_addr;
    ...
    list_print("try to detect gs5604 ... \n");
#if 0 
    regs.reg_num[0] = 0x30;
	regs.reg_num[1] = 0x0a;
    ret = camera_i2c_read(i2c_adap, regs.reg_num, regs.value, i2c_addr, addr_step, data_step);
...
#endif
    list_print("detect gs5604 success!!\n");
...
__camera_list_t camera_list[MAX_CAMERA_LIST_ITEM] = {
    ...
    CAMERA_LIST_ITEM_INIT(gs5604,        2, 1, 0x34, 1, 0, 0, 1, 1, 0),
};
