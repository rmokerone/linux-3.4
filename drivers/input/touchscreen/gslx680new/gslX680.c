...
#include "gslX680_3675_pg_800x480_16.h"
#include "gslX680_3675_pg_1024x600_16.h"
#include "gslX680_3675_pg_800x480_14.h"
#include "gslX680_3675_pg_1024x600_14.h"
#include "gsl1680e_dvk3.h"
#include "gsl1680e_dvk3_1024x600.h"
...
struct gslX680_fw_array {
	...
	{"gslx680_fw"  ,  ARRAY_SIZE(GSLX680_FW),GSLX680_FW},
	{"gslX680_3675_pg_800x480_14"  ,  ARRAY_SIZE(GSLX680_FW_3675_PG_800X480_14),GSLX680_FW_3675_PG_800X480_14},
	{"gslX680_3675_pg_1024x600_14"  ,  ARRAY_SIZE(GSLX680_FW_3675_PG_1024X600_14),GSLX680_FW_3675_PG_1024X600_14},
	{"gslX680_3675_pg_800x480_16"  ,  ARRAY_SIZE(GSLX680_FW_3675_PG_800X480_16),GSLX680_FW_3675_PG_800X480_16},
	{"gslX680_3675_pg_1024x600_16"  ,  ARRAY_SIZE(GSLX680_FW_3675_PG_1024X600_16),GSLX680_FW_3675_PG_1024X600_16},
	{"gsl1680e_p2"  ,  ARRAY_SIZE(GSL1680E_FW_P2),GSL1680E_FW_P2},
	{"gsl1680e_dvk3"  ,  ARRAY_SIZE(GSL1680E_FW),GSL1680E_FW},
	{"gsl1680e_dvk3_1024x600"  ,  ARRAY_SIZE(GSL1680E_FW_1024x600),GSL1680E_FW_1024x600},
};

unsigned int *gslX680_config_data[16] = {
    gsl_config_data_id_K71_OGS_1024600,    
    gsl_config_data_id,     
    gsl_config_data_id_3675_PG_800X480_14,  
    gsl_config_data_id_3675_PG_1024X600_14,   
    gsl_config_data_id_3675_PG_800X480_16,  
    gsl_config_data_id_3675_PG_1024X600_16,
    gsl_config_data_id_P2,    
    gsl_config_data_id_dvk3,
    gsl_config_data_id_dvk3_1024x600,
};
...
static void check_mem_data(struct i2c_client *client)
{
	...
	//if(gsl_chipType_new == 1)	
	{
		...
		printk(KERN_ERR "#########check mem read 0xb0 = %x %x %x %x #########\n", read_buf[3], read_buf[2], read_buf[1], read_buf[0]);
...
static int gsl_config_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data)
{
	...
	else if('r'==gsl_read[0]&&'e'==gsl_read[1])
	{
		...
		{
			gsl_ts_write(gslX680_i2c,0xf0,&gsl_data_proc[4],4);
			gsl_ts_read(gslX680_i2c,gsl_data_proc[0],temp_data,4);
			gsl_ts_read(gslX680_i2c,gsl_data_proc[0],temp_data,4);
...
static int gsl_config_write_proc(struct file *file, const char *buffer, unsigned long count, void *data)
{
	...
	{
		gsl_proc_flag = 1;
		reset_chip(gslX680_i2c);
	}
	else if('e'==gsl_read[0]&&'n'==gsl_read[1])//end //en
	{
		msleep(20);
		reset_chip(gslX680_i2c);
		startup_chip(gslX680_i2c);
...
gsl_DataInit(gslX680_config_data[fw_index]);	
	...
	{
		gsl_ts_write(gslX680_i2c,buf[4],buf,4);
	}
...
static void gsl_monitor_worker(void)
{
	...
	gsl_ts_read(gslX680_i2c, 0xb0, read_buf, 4);
	if(read_buf[3] != 0x5a || read_buf[2] != 0x5a || read_buf[1] != 0x5a || read_buf[0] != 0x5a)
		b0_counter ++;
	else
		b0_counter = 0;
	...
	gsl_ts_read(gslX680_i2c, 0xb4, read_buf, 4);	
	int_2nd[3] = int_1st[3];
	int_2nd[2] = int_1st[2];
	int_2nd[1] = int_1st[1];
	int_2nd[0] = int_1st[0];
	...
	write_buf[1] = 0x10;
	write_buf[0] = 0x00;
	gsl_ts_write(gslX680_i2c, 0xf0, write_buf, 4);
	msleep(50);
	gsl_ts_read(gslX680_i2c, 0x10, read_buf, 4);
	gsl_ts_read(gslX680_i2c, 0x10, read_buf, 4);
...
static void gslX680_resume_events (struct work_struct *work)
{
	struct gsl_ts *ts = i2c_get_clientdata(gslX680_i2c);
	int ret =0;
...
static int gsl_ts_suspend(struct i2c_client *client, pm_message_t mesg)
{
        ...
        cancel_work_sync(&gslX680_resume_work);
  	    flush_workqueue(gslX680_resume_wq);
  	printk(KERN_ERR "------------bbbbbbbbbb----------\n");
...
static int gsl_ts_resume(struct i2c_client *client)
{
	...
	flush_workqueue(ts->wq);
	init_chip(gslX680_i2c);
	//queue_work(gslX680_resume_wq, &gslX680_resume_work);
...
static void gslX680_init_events (struct work_struct *work)
{
	...
	if (ret) {
		printk("gslX680_init_events: request irq failed\n");
	}
			...
			const struct i2c_device_id *id)
{
	...
	ts_init = ts;
	queue_work(gslX680_wq, &gslX680_init_work);
...
static int __devexit gsl_ts_remove(struct i2c_client *client)
{
	...
	cancel_work_sync(&ts->work);
	cancel_work_sync(&gslX680_init_work);
	cancel_work_sync(&gslX680_resume_work);
