...
#ifdef HW_OOB
	if(!host_wake_invert)
	  host_oob_irq_flags = IRQF_TRIGGER_HIGH;//TRIG_LEVEL_HIGH;
	else
	  host_oob_irq_flags = IRQF_TRIGGER_LOW;//TRIG_LEVEL_LOW;
#else
	host_oob_irq_flags = TRIG_LEVL_HIGHEDGE;
#endif
#endif
